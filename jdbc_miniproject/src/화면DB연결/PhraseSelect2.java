...
public class PhraseSelect2 { // 책 아이디(번호)로 검색
	...
	public void open() {
		...
		int input = Integer.parseInt(JOptionPane.showInputDialog(f, "검색할 책ID(번호)를 입력하세요."));

		ArrayList<PhraseVO> list = dao.list3(input);
